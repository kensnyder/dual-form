...
var elements = {};
elements.Element = Element.subclass({
...
elements.Textarea = elements.Element.subclass({
	tagName: 'textarea',
	render: function() {
...
elements.Input = elements.Element.subclass({
	tagName: 'input',
	construct: function() {
...
elements.ElementList = Base.subclass({
	...
	get: elements.prototype.get,
	find: elements.prototype.find,
	add: elements.prototype.add,
	renderElements: elements.prototype.renderElements,
	render: elements.prototype.renderElements
});
...
elements.Option = elements.Element.subclass({
	tagName: 'option',
	construct: function() {
...
elements.Select = elements.Element.subclass({
	tagName: 'select',
	construct: function() {
		this.options = [];
